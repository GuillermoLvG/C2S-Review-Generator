...
INITIAL_WORD = "<sos>"
TEST_CONTEXT = 38 #VARIAR NUMERO PARA VER OTROS CONTEXTOS
...
def create_C2S_model(
    ...
    model.load_weights("pesos_implementacion.hdf5")
...
def main():
    ...
    if os.path.exists("resources/contexts_tr"):
        ...
        decoder_reviews_input_tr = pickle.load(open(
            "resources/decoder_reviews_input_tr", "rb"))
        decoder_reviews_input_te = pickle.load(open(
            "resources/decoder_reviews_input_te", "rb"))
        decoder_reviews_input_va = pickle.load(open(
            "resources/decoder_reviews_input_va", "rb"))
        decoder_reviews_target_tr = pickle.load(open(
            "resources/decoder_reviews_target_tr", "rb"))
        decoder_reviews_target_te = pickle.load(open(
            "resources/decoder_reviews_target_te", "rb"))
        decoder_reviews_target_va = pickle.load(open(
            "resources/decoder_reviews_target_va", "rb"))
    else:
        ...
        pickle.dump(decoder_reviews_input_tr, open(
            "resources/decoder_reviews_input_tr", "wb"))
        pickle.dump(decoder_reviews_input_te, open(
            "resources/decoder_reviews_input_te", "wb"))
        pickle.dump(decoder_reviews_input_va, open(
            "resources/decoder_reviews_input_va", "wb"))
        pickle.dump(decoder_reviews_target_tr, open(
            "resources/decoder_reviews_target_tr", "wb"))
        pickle.dump(decoder_reviews_target_te, open(
            "resources/decoder_reviews_target_te", "wb"))
        pickle.dump(decoder_reviews_target_va, open(
            "resources/decoder_reviews_target_va", "wb"))
    ...
    contexts = pickle.load(open("resources/contexts.pkl", "rb"))
